...
public class NotUseSuperAttendingVessel extends RW{
	...
	public void UserList(WebDriver driver1) throws InterruptedException {         //(priority=22)
		...
		public void AddUserRight(WebDriver driver1) throws Exception {         //(priority=23)
		...
		public void AddUserLeft(WebDriver driver1) throws Exception {         //(priority=24)
